...
export default function SemiFormal({ auth }) {
    ...
    useEffect(() => {
        const fetchImages = async () => {
            try {
                const response = await axios.get('/images/semi-formal');
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Semi-Formal</h2>}
        >
            <Head title="Semi-Formal" />
